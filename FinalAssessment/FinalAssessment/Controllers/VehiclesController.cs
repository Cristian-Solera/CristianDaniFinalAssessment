...
namespace FinalAssessment.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public VehiclesController(FinalAssessmentDbContext context)
        {
            _context = context;
        }
        ...
        {
            var finalAssessmentDbContext = _context.Vehicles.Include(v => v.Owner);
            return View(await finalAssessmentDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalAssessmentDbContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
