...
namespace FinalAssessment.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(FinalAssessmentDbContext context)
        {
            _context = context;
        }
        ...
        {
            var finalAssessmentDbContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalAssessmentDbContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
